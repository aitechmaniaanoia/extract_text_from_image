# -*- coding: utf-8 -*-
"""
Created on Tue Jan  5 13:34:09 2021
...
#pytesseract.pytesseract.tesseract_cmd = 'C:\\Users\\Zoe\\anaconda3\\Scripts\\tesseract.exe'
...
def extract(path):
    ...
    #texts = pytesseract.image_to_string(Sample_img, lang='chi_tra') 
    mytext=""
    prevy=0
